...
const SignIn = () => {
    ...
    const handleLogin = async () => {
        setLoading(true);
        try{
            const response= await apiClient.post("/auth/login", {"api_key": "dda6216b-be2d-457f-84a3-a0ac6dd20bf1"})
            ...
            Alert.alert(`Login Failed: ${errorType}`);
        } finally  {
            setLoading(false);
        }
    }
                ...
                <View className="flex-1 bg-white px-5 justify-end mb-12">
                    ...
                    <Text className="text-sm font-poppins-semibold text-left my-5">
                        Modern shopping solution focused on a healthy balanced lifestyle. We provide a variety of quality support for your health needs.
                            ...
                            <TouchableOpacity className="w-5/6 h-14 my-2 self-center" onPress={pressedSignin}>
