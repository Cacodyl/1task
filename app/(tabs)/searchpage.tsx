  ...
  return (
    <SafeAreaView className="flex-1">
      <View className="h-2/5 text-xl font-poppins">
        <Image
          source={require("../../assets/icons/Rectangle 32 - Copy.png")}
      ...
      <View className="h-2/5 bg-white border-0.5 border-gray-200 rounded-lg">
        ...
        <Text className="text-sm font-poppins text-gray-500 px-5 pt-2">
          Power salads are nutrient-dense and flavorful dishes designed to
          provide energy and support a healthy lifestyle. Combining various
          fresh and nutritious ingredients, such as leafy greens, grains, nuts,
          and proteins, makes power salads not only filling but also beneficial
          for health. Read More
        </Text>
        <Text
      ...
      <View className="h-1/5 bg-white shadow-2xl"></View>
    </SafeAreaView>
  );
};
